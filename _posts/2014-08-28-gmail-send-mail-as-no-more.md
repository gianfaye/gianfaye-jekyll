...
Also, you cannot receive more than one email every 10 minutes or else it will block the sender. And if you enable the 2-Step verification process you might have to disable it.
	...
	Tip: If you don't want to sacrifice the security of your account you may create or use another Gmail account you own for this purpose. Just use that Gmail address and its password on the SMTP settings and it should work fine.
